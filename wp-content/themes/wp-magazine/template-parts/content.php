...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="summary">
        ...
        <?php } ?>       
        <h4 class="blog-news-title"><a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark"><?php the_title(); ?></a></h4>
        ...
        <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" title="" class="readmore">
          <?php echo esc_html( get_theme_mod( 'readmore_text', 'Читать далее' ) ); ?>
        </a>
